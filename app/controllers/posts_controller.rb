class PostsController < ApplicationController
  ...
  before_action(:authorize_user_admin, except: [:show, :new, :create, :edit, :update, :destory])

  before_action(:authorize_user_moderator, except: [:show, :new, :create, :edit, :update])
